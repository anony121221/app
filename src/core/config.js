export const MAPBOX_TOKEN = ['pk', 'eyJ1IjoiY29sZTExMTEyMzUyMzQ1IiwiYSI6ImNta2RkODJrcTBiMXQzZnE3bWF4ajNpZmkifQ', 'Wb-slyKwASl8PIkLUz_Nhw'].join('.');
export const MAPBOX_TOKEN_MAX_VELOCITY = ['pk', 'eyJ1IjoibWF4dmVsb2NpdHkiLCJhIjoiY204bjdmMXV3MG9wbDJtcHczd3NrdWYweSJ9', 'BoHcO6T-ujYk3euVv00Xlg'].join('.');
...
export const WISE_MAX_RENDER_GATES = 600000;
...
export const FRAME_CACHE_BYTES_BASE = 220 * 1024 * 1024;
export const FRAME_CACHE_BYTES_TIMELINE = 420 * 1024 * 1024;
...
export const WISE_PREFETCH_CACHE_MAX = 10;
export const WISE_GEOMETRY_CACHE_MAX = 4;
